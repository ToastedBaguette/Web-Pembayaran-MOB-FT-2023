...
@section('user_content')
  ...
  <div class="btn-fab-container">
    <a href="https://forms.gle/2XpRv5rLVAd9cvte6" target="_blank" class="btn btn-fab shadow text-white rounded-circle d-flex justify-content-center align-items-center">
